 ...
 * 开始播放音视频流。
 *
 * @note 10.7 版本开始，需要通过 {@link V2TXLivePremier#setLicence} 或者 {@link TXLiveBase#setLicence} 设置 Licence 后方可成功播放，否则将播放失败（黑屏），全局仅设置一次即可。直播 Licence、短视频 Licence 和视频播放 Licence 均可使用，若您暂未获取上述
